...
<head>
    ...
    <title>JVA Cargo Freight, Inc.</title>

    <link href='https://fonts.googleapis.com/css?family=Quicksand' rel='stylesheet' type='text/css'>
    <link href='https://fonts.googleapis.com/css?family=Jacques+Francois' rel='stylesheet' type='text/css'><link href='https://fonts.googleapis.com/css?family=Open+Sans:400,800' rel='stylesheet' type='text/css'>

    <!-- Bootstrap Core CSS -->
    <link href="{{ asset('themes/metronic/assets/global/plugins/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="{{ asset('themes/metronic/assets/global/plugins/startbootstrap-full-slider/css/full-slider.css') }}" rel="stylesheet">

    <!-- Header CSS -->
    <link href="{{ asset('themes/metronic/assets/pages/css/header.css') }}" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="{{ asset('themes/metronic/assets/pages/css/custom.css') }}" rel="stylesheet">

    <!-- Parallax CSS -->
    <link rel="stylesheet" href="{{ asset('themes/parallax/css/base.css') }}">
    <link rel="stylesheet" href="{{ asset('themes/parallax/css/style.css') }}">
...
<body>
    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill slide-1"></div>
                <div class="carousel-caption">
                    <h2>Superior Air Freight Management</h2>
                </div>
            </div>
            <div class="item">
                <!-- Set the second background image using inline CSS below. -->
                <div class="fill slide-2"></div>
                <div class="carousel-caption">
                    <h2>Fast Service</h2>
                </div>
            </div>
            <div class="item">
                ...
                <div class="fill slide-3"></div>
                <div class="carousel-caption">
                    <h2>Dependable Cargo Transport</h2>
                </div>
            </div>
        </div>
  ...
  <main>
    <section class="module content" id="about">
        <div class="container">
            <h4>WHAT WE DO</h4>
            <p>JVA Cargo Freight, Inc. was established by competent and seasoned professionals of the industry. Their distinguished achievements and vast experiences in customs brokerage, international and domestic freight forwarding, warehousing, and logistics management will surely provide tailor-made freight forwarding solutions to both corporate and individual clients.</p>
            <p>We offer a spectrum of freight related services and can efficiently manage any nature of shipment. We aim to achieve customer satisfaction and loyalty thru our effective management of all their transportation and logistics requirements.
            </p>
        </div>
    </section>
      
    <section class="module parallax parallax-1" id="services">
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-4">
                    <div class="service-box">
                        <h3 style="color:#FFFFFF;">LCL: (Less Than Container Load)</h3>
                        <p style="color:#FFFFFF;  font-size:16px;">In the case of our customers not having enough cargo for a full container, we offer Less-Than-Container Load (LCL) services between major ports globally. We have an extensive network of capabilities that allows us to offer you space within a container that is shared with other customers’ goods to deliver economical usage-based costing. All this, while at the same time, providing Full-Container-Load (FCL) frequency, routing and visibility.</p>
                        <p style="color:#FFFFFF;  font-size:16px;">LCL consolidation is one of our core businesses and we believe that our persistent drive for innovation in routing, transit time, and safe delivery is the key to success in LCL consolidation.</p>
                    </div>
                </div>            
            </div>            
        </div>
                ...
                <div class="col-md-4">
                    <div class="service-box">
                        ...
                        <ul style="color:#FFFFFF;  font-size:16px;">
                            ...
                            <li>Door to door</li>
                            <li>The lowest rate in the market</li>
                            <li>Extensive coverage</li>
                            <li>Tranquility and security</li>
                            <li>Minimum security measures and demands</li>
                            <li>Container Insurance</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-4">                    
    ...
    <section class="module content" id="profile">
        <div class="container">
            <h3>OUR OBJECTIVE AND DIRECTION</h3>
            <p>Our goal is to maintain and strengthen our position as the leading logistics provider for both air and sea freight. The services and the solutions we offer are in line with industry development. We are committed to invest in information technology to efficiently support our customers’ supply chain.</p>
            <p>Customer satisfaction is our mission. We have obligated ourselves to provide quality services. We aim to give them trouble-free and expeditious services at the lowest possible cost and at the soonest possible time.
            </p>
        </div>
    </section>
    ...
    <section class="module parallax parallax-3" id="contact">
        <div class="container">
            ...
            <div class="col-md-6" style="margin-top:40px;">                    
                <div class="service-box">
                    <h5 style="color:#FFFFFF;">Corporate Office</h5>
                    <p style="color:#FFFFFF;  font-size:16px;">Unit UG19 Cityland Pioneer, 128 Pioneer St., Mandaluyong City, Philippines</p>
                </div>
            </div>
            <div class="col-md-6" style="margin-top:40px;">
                <div class="service-box">
                    <h5 style="color:#FFFFFF;">Trunk Line</h5>
                    <p style="color:#FFFFFF;  font-size:16px;">(632) 6350523<br>
                    (632)6350523 (Brokerage operation)</p>
                </div>
            </div>
            <div class="col-md-6" style="margin-top:40px;">
                <div class="service-box">
                    <h5 style="color:#FFFFFF;">Telefax No.</h5>
                    <p style="color:#FFFFFF;  font-size:16px;">(632) 6318610<br></p>
                </div>
            </div>
            <div class="col-md-6" style="margin-top:40px;">
                <div class="service-box">
                    <h5 style="color:#FFFFFF;">Email Address</h5>
                    <p style="color:#FFFFFF;  font-size:16px;">joseph.ascutia@jvacargo.com.ph<br>cham.ascutia@jvacargo.com.ph</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- jQuery -->
    <script src="{{ asset('themes/metronic/assets/global/plugins/jquery.min.js') }}"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="{{ asset('themes/metronic/assets/global/plugins/bootstrap/js/bootstrap.min.js') }}"></script>
